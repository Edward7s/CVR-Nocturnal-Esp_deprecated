...
namespace Nocturnal
{
    ...
    internal class Config
    {
        ...
        public Config()
        {
            ...
            if (!File.Exists(Directory.GetCurrentDirectory() + "//Nocturnal//Config.Json"))
                File.WriteAllText(Directory.GetCurrentDirectory() + "//Nocturnal//Config.Json", JsonConvert.SerializeObject(new Json()
                {
            ...
            s_js = JsonConvert.DeserializeObject<Json>(File.ReadAllText(Directory.GetCurrentDirectory() + "//Nocturnal//Config.Json"));
